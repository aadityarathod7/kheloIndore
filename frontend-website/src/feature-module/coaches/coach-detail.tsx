...
const CoachDetail = (props: any) => {
  ...
  return (
    <div className="venue-coach-details coach-detail top-margin ki-provider-detail ki-coach-detail" style={{ backgroundColor: "#F8FAFC" }}>
      {/* Hero Section */}
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .verified-coach-badge { display: inline-flex !important; align-items: center !important; margin-left: 8px !important; color: #22C55E !important; font-size: 20px !important; }
        .verified-coach-badge i { color: #22C55E !important; }
              ...
              <div className="venue-options white-bg mb-4">
                <ul className="clearfix">
                  <li className={activeSection === "coach-details" ? "active" : ""}>
                    <Link onClick={(event) => { event.preventDefault(); openSection("coach-details"); }} to="#coach-details">
                      Coach Details
                    </Link>
                  </li>
                  ...
                  <li className={activeSection === "specializations" ? "active" : ""}>
                    <Link onClick={(event) => { event.preventDefault(); openSection("specializations"); }} to="#specializations">
                      Specializations
                    </Link>
                  </li>
