    ...
    <div>
      ...
      <section className="breadcrumb breadcrumb-list mb-0">
        ...
        <div className="container">
          <h1 className="text-white">Coaches Grid Sidebar</h1>
          <ul>
            <li>
      ...
      {/* /Breadcrumb */}
      {/* Page Content */}
      <div className="content listing-page">
        <div className="container">
          {/* Sort By */}
          <div className="row">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              ...
                              fostering love for the game and results.
                            </p>
                          </div>
                          <div className="coach-btn">
                            <ul>
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              ...
                              techniques for best results the game.
                            </p>
                          </div>
                          <div className="coach-btn">
                            <ul>
...
export default CoachesGridSidebar;
