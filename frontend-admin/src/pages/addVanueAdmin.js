...
const AddVenueAdmin = () => {
    ...
    try {
      ...
      if (response.data.success) {
        Swal.fire({
          icon: "success",
          title: "Success!",
          text: "Venue Admin added successfully",
        }).then(() => {
          navigate('/venue-admin');
        });
      } else {
        // Handle case when API response does not indicate success
        Swal.fire({
          icon: "error",
          title: "Error",
  ...
  return (
    <>
      <h3 className="mb-4 title">Add Venue Admin</h3>
      <Container
        style={{
          maxWidth: "1000px",
